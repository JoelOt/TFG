\chapter{Elaboració d'atacs per a la genració de trànsit maliciós}
...
\bottomrule
\end{tabular}
\caption{Petit extret del fitxer "MAC Address Block Large (MA-S)" de \cite{iotmaclist} filtrat per a visualitzar nomès fabricants IoMT on es veuen parelles IniciMAC - Fabricant}  % Peu de figura
